...
from app.models.seo import SeoKeyword, SeoTemplate, SeoGeneratedContent, SeoKeywordCandidate
...
__all__ = [
    ...
    "SeoKeyword", "SeoTemplate", "SeoGeneratedContent", "SeoKeywordCandidate",
