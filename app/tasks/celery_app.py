...
celery_app.conf.beat_schedule = {
    ...
    # 2026-04-28 用户拍解除 WB 静默全开（04-24 因 quota 全天事故拍停 5 个 WB beat）
    ...
    # 注：4-28 老张已把 WB 同步改"按天补缺失"模式镜像 Ozon
