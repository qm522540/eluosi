...
DATA_SOURCES = {
    ...
    "wb_products": {
        ...
        "category": "api",
        "platform": "wb",
        "schedule_desc": "用户手动触发",
        "task_name": "app.services.product.service.sync_products_from_platform",
        "manual_only": True,
        "depends": ["seller token"],
    },
    "wb_campaigns": {
        ...
        "platform": "wb",
        "schedule_desc": "用户手动触发",
        "task_name": "app.api.v1.ads._sync_wb_campaigns",
        "manual_only": True,
    ...
    "ozon_campaigns": {
        ...
        "platform": "ozon",
        "schedule_desc": "用户手动触发",
        "task_name": "app.api.v1.ads._sync_ozon_campaigns",
        "manual_only": True,
